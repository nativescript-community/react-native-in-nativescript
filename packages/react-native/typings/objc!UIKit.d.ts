...
declare class NSTextStorage extends NSMutableAttributedString implements NSSecureCoding {
	...
	scaleFontSizeToFitSizeMinimumFontSizeMaximumFontSize(size: CGSize, minimumFontSize: number, maximumFontSize: number): void;

	scaleFontSizeToFitSizeMinimumFontSizeMaximumFontSizeMethod(size: CGSize, minimumFontSize: number, maximumFontSize: number): void;

	scaleFontSizeWithRatioMinimumFontSizeMaximumFontSize(ratio: number, minimumFontSize: number, maximumFontSize: number): void;

	scaleFontSizeWithRatioMinimumFontSizeMaximumFontSizeMethod(ratio: number, minimumFontSize: number, maximumFontSize: number): void;
}
...
declare class UIView extends UIResponder implements CALayerDelegate, NSCoding, RCTComponent, UIAccessibilityIdentification, UIAppearance, UIAppearanceContainer, UICoordinateSpace, UIDynamicItem, UIFocusItem, UIFocusItemContainer, UILargeContentViewerItem, UITraitEnvironment {
	...
	accessibilityActions: NSArray<NSDictionary<any, any>>;

	accessibilityIgnoresInvertColors: boolean;

	accessibilityRole: string;

	accessibilityState: NSDictionary<string, any>;

	accessibilityValueInternal: NSDictionary<any, any>;
	...
	readonly reactAccessibilityElement: UIView;

	readonly reactBorderInsets: UIEdgeInsets;

	readonly reactCompoundInsets: UIEdgeInsets;

	readonly reactContentFrame: CGRect;

	reactDisplay: YGDisplay;

	reactLayoutDirection: UIUserInterfaceLayoutDirection;

	readonly reactPaddingInsets: UIEdgeInsets;
	...
	shouldAccessibilityIgnoresInvertColors: boolean;
	...
	reactFocusIfNeeded(): void;

	reactSetFrame(frame: CGRect): void;
	...
	reactZIndexSortedSubviews(): NSArray<UIView>;

	react_findClipView(): UIView;

	react_recursiveDescription(): string;

	react_remountAllSubviews(): void;

	react_updateClippedSubviewsWithClipRectRelativeToView(clipRect: CGRect, clipView: UIView): void;
